...
module.exports = {
  ...
  excludeFiles: [
    /\.(md|wp).(scss)$/i,
    /(action-sheet|alert|backdrop|badge|card|checkbox|chip|datetime|fab|grid|icon|img|infinite-scroll|item|label|list|loading|menu|modal|note|picker|popover|radio|range|refresher|searchbar|segment|select|show-hide-when|slides|split-pane|spinner|tabs|toggle|virtual-scroll|cordova)/i,
  ],
